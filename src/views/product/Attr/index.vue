  ...
  <div>
    ...
    <el-card class="box-card">
      <div v-show="isShowTable">
        ...
        <el-table :data="AtterList" border style="width: 100%">
          <el-table-column
            type="index"
            width="80px"
            align="center"
      ...
      <div v-show="!isShowTable">
        <el-form :model="attrInfo">
          <el-form-item label="属性名">
            ...
            <el-button style="margin-left: 20px" @click="isShowTable = true"
              >取消</el-button
            >
          </el-form-item>
          <el-form-item>
              ...
              <el-table-column width="100px" label="操作" align="center">
                <template slot-scope="{ row, $index }">
                  <el-popconfirm
                    ...
                    @onConfirm="deleattrValueList(row, $index)"
                  >
                    <el-button
                      slot="reference"
                      type="danger"
